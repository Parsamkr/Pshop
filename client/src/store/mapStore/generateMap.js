...
//   const initialData = (name, cityname, lat, lng) => {
//     return {
//       Province: name,
//       cities: [{ city: cityname, lat: lat, lng: lng }],
//     };
//   };
//   const initialCity = (cityname, lat, lng) => {
//     return { city: cityname, lat: lat, lng: lng };
//   };
...
//     },
//     {
//       city: "Pā’īn Maḩalleh-ye Foshtom",
//       lat: "37.2811",
//       lng: "49.8686",
//       country: "Iran",
//       iso2: "IR",
...
//     // Replace diacritics with their corresponding Latin characters commonly used in Persian
//     const normalizedName = name
//       .replace(/[\u064a\u0628\u06cc]/g, "k") // ك kaf, كاف, كه‌
//       .replace(/[\u0644\u062c\u0686]/g, "g") // گ gim, گاف, گه‌
//       .replace(/[\u062a\u062b\u0656]/g, "h") // ح hā, هـ, هه‌
//       .replace(/[\u0633\u0698\u06a9]/g, "t") // ت tā, تاء, ته‌
//       .replace(/[\u062d\u0688]/g, "d") // د dāl, دال
//       .replace(/[\u0636\u0691\u0693]/g, "z") // ز zāy, زاي, زه‌
//       .replace(/[\u0637\u062e\u063a]/g, "j") // ژ zhim, ژيم
//       .replace(/[\u0627\u067e]/g, "ch") // چ chim, چيم
//       .replace(/[\u0643\u06af]/g, "p") // پ pē, پي
//       .replace(/[\u0628\u067b]/g, "b") // ب bā, بـ
//       .replace(/[\u0645\u0629]/g, "a") // ا alef, الف
//       .replace(/[\u0649\u0626]/g, "o") // و vāv, واو
//       .replace(/[\u0642\u062f]/g, "i"); // ي yā, يـ

//     // Remove any remaining non-alphanumeric characters
//     return normalizedName.replace(/[^a-zA-Z0-9 ]/g, "").trim();
//   }
//   const generateMyMapData = async (data) => {
//     data.map((city) => {
//       const index = mapData.findIndex(
//         (item) => item.Province === city.admin_name
//       );
//       if (index == -1) {
//         mapData.push(
//           initialData(
//             normalizeName(city.admin_name),
...
//         );
//       } else {
//         mapData[index].cities.push(
//           initialCity(normalizeName(city.city), city.lat, city.lng)
//         );
//       }
//     });
//   };

//   await generateMyMapData(data);
...
const generateMapData = async () => {
  const mydata = (async () => {
    const response = await fetch(
      "https://parseapi.back4app.com/classes/List_places_Iran?count=1&limit=0",
      {
        headers: {
          "X-Parse-Application-Id": "TFbWogFpFR9dXk06pLTZGRwtH5auJfpQujWekhGY", // This is the fake app's application id
          "X-Parse-Master-Key": "w2s0WT1H48jR2L7iVLBQSHdstjLdcvtXviIpxV7k", // This is the fake app's readonly master key
        },
      }
    );
